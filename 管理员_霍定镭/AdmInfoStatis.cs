...
namespace 管理员
{
    class AdmInfoStatis
    {
        ...
        public void AdmInfo(int adm_id)
        {
            string connString = "server=localhost;database=db_mall;uid=root;pwd=1234567890";
            ...
            using (MySqlCommand cmd = new MySqlCommand())//创建查询命令
            {
                ...
                cmd.Connection = conn;
                cmd.CommandText = sql;
                cmd.Parameters.Add(new MySqlParameter("@adm_id", adm_id));
