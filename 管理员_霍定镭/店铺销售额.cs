...
namespace 管理员
{
    public partial class 店铺销售额 : Form
    {
        public 店铺销售额()
        {
            InitializeComponent();
        ...
        //加载“店铺销售额”窗体
        private void 店铺销售额_Load(object sender, EventArgs e)
        {
            //添加店铺种类
        ...
        //关闭“店铺销售额”窗体后
        private void 店铺销售额_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void button_query_Click(object sender, EventArgs e)
        {
            ...
            查询结果.info_店铺销售额或销量 info = new 查询结果.info_店铺销售额或销量();
            int num = 0;
